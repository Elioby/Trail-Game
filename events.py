...
# This is an example event function, it returns the message to notify the player with
def event_bitten_by_zombie():
	random_survivor = get_random_survivor(False, False)
